...
\begin{figure*}[h!]
    ...
    \caption{
        \scriptsize \emph{Left:} Mass-weighted R$_{\rm GC}$ distribution of 
        all Auriga haloes (level 3, 4 and 5).
...
\begin{figure*}[h!]
    ...
    \caption{
        \emph{Left:} Mass-weighted R$_{\rm GC}$ distribution of 
        all Auriga haloes (level 3, 4 and 5).
        \emph{Right:} 
        \label{fig:todo7}
    }
...
\begin{figure*}[h!]
    ...
    \caption{
        \emph{Left:} Mass-weighted R$_{\rm GC}$-[Fe/H] distribution of 
