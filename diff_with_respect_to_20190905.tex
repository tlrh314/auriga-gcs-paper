...
%DIF DEL AurigaGCS_20190905.tex   Tue Apr  7 23:53:17 2020
%DIF ADD AurigaGCS.tex            Tue Apr 14 22:29:46 2020
%
...
is adequately understood. However, despite decades of research (\DIFdelbegin \DIFdel{the extensive 
literature on GCs is summarised in several books and review articles, }\DIFdelend e.g.~\citealt{
...
exhaustive picture of the formation of GCs is yet to be reached. \DIFaddbegin \DIFadd{Most galaxies host
...
\mbox{%DIFAUXCMD
\citep{2006ARA&A..44..193B}}\hspace{0pt}%DIFAUXCMD
. GCs are typically referred to as `blue' or `red' \mbox{%DIFAUXCMD
\citep[e.g.][]{
1985ApJ...293..424Z,1999AJ....118.1526G,2001AJ....121.2974L} }\hspace{0pt}%DIFAUXCMD
where the former class
is more metal-poor, more radially extended, and showing little to no rotation wheras
the later is more metal-rich, radially concentrated, and rotating with the galaxy.
}\DIFaddend 

The literature offers a wealth of formation scenarios\DIFaddbegin \DIFadd{, many of which focus on the
distinct characteristics of the blue or red subpopulation}\DIFaddend . \citet{1968ApJ...154..891P}
...
accretion and mergers \DIFdelbegin \DIFdel{continuously occurs }\DIFdelend \DIFaddbegin \DIFadd{continually occur }\DIFaddend during the hierarchical build-up of
...
this framework, differences between \DIFdelbegin \DIFdel{both }\DIFdelend \DIFaddbegin \DIFadd{the two }\DIFaddend classes of objects are caused by nearly a 
...
2019MNRAS.486..331C,2019arXiv190505199C}, \DIFdelbegin \DIFdel{as is }\DIFdelend \DIFaddbegin \DIFadd{also }\DIFaddend done in the work by 
...
the star formation histories of the simulations \DIFaddbegin \DIFadd{could }\DIFaddend give rise to a GCS similar to 
...
model produces enough stellar mass with the right properties\DIFdelbegin \DIFdel{to allow for formation efficiencies lower than unity and the expected (dynamical) mass loss over the cluster lifetime (not modelled 
explicitly in this study)}\DIFdelend \DIFaddbegin \DIFadd{. Moreover, the simulations
...
}{\it \DIFadd{in~situ}} \DIFadd{versus those that have been accreted. We focus on the metallicity
and radial distributions because observations of the red and blue GCs show
distinct differences between these properties}\DIFaddend .

The plan of the paper is as follows. We summarise the relevant characteristics 
of the Auriga simulations in \DIFdelbegin \DIFdel{section}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:auriga}, followed by a summary of 
the observations of the MW and M31 GCSs
in \DIFdelbegin \DIFdel{section}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:observations} that we \DIFdelbegin \DIFdel{use to }\DIFdelend compare our simulations to in
\DIFdelbegin \DIFdel{section}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:results}. We discuss our findings in \DIFdelbegin \DIFdel{section}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:discussion}
to come to our conclusions in \DIFdelbegin \DIFdel{section}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:conclusions}.
...
selected initial conditions \DIFaddbegin \DIFadd{in the range $1-2 \times 10^{12}$~M$_{\odot}$
}\DIFaddend were selected from the \mbox{\textsc{eagle}} \DIFdelbegin \DIFdel{DM only 
}\DIFdelend \DIFaddbegin \DIFadd{DM-only }\DIFaddend box, see 
\citetalias{2017MNRAS.467..179G} for details. The simulations are 
...
of cold clouds and the photoevaporation of clouds. Stars form \DIFdelbegin \DIFdel{stocastically }\DIFdelend \DIFaddbegin \DIFadd{stochastically }\DIFaddend in 
...
branch }\DIFaddend stars \citep{2013MNRAS.436.3031V}. Supermassive
...
with gravitational softening of \DIFdelbegin \DIFdel{collissionless }\DIFdelend \DIFaddbegin \DIFadd{collisionless }\DIFaddend particles $\epsilon$~=~369~pc.
...
respectively. The mass resolution of the Auriga simulations is thus close \DIFaddbegin \DIFadd{$10^{5}$~M}\Sun\DIFadd{,
}\DIFaddend to the characteristic peak mass of the lognormal GC mass distribution 
\DIFdelbegin \DIFdel{of $10^{5}$~M}%DIFDELCMD < \Sun 
%DIFDELCMD < %%%
\DIFdelend \citep{1991ARA&A..29..543H}, although the gravitational softening is two orders 
...
This means that their formation sites \DIFdelbegin \DIFdel{and that of a }\DIFdelend \DIFaddbegin \DIFadd{could be consistent with those of }\DIFaddend real-world \DIFdelbegin \DIFdel{GC may be consistent }\DIFdelend \DIFaddbegin \DIFadd{GCs}\DIFaddend .

\section{Observational data}
\label{sec:observations}
We describe \DIFdelbegin \DIFdel{the }\DIFdelend observations of the MW GCS in \DIFdelbegin \DIFdel{Sec.~\ref{sec:milkyway} }\DIFdelend \DIFaddbegin \DIFadd{Section~\ref{sec:milkyway} for these clusters}\DIFaddend ,
and of the M31 GCS in \DIFdelbegin \DIFdel{Sec.~\ref{sec:andromeda}}\DIFdelend \DIFaddbegin \DIFadd{Section~\ref{sec:andromeda}. We discuss age-estimates
...
thus, their catalogue to be ${\sim}$85\% complete. However, an additional 59 \DIFdelbegin \DIFdel{GCs
are claimed to }\DIFdelend \DIFaddbegin \DIFadd{GC
candidates }\DIFaddend have been discovered \DIFaddbegin \DIFadd{more recently }\DIFaddend by various authors. The total number of GCs
in the MW might \DIFdelbegin \DIFdel{add up to }\DIFdelend \DIFaddbegin \DIFadd{thus be }\DIFaddend 216 with recent estimates now anticipating an additional 
...
collecting integrated properties of the GCS of M31 \mbox{%DIFAUXCMD
\citep[][and references therein]{2004A&A...416..917G}}\hspace{0pt}%DIFAUXCMD
. One
contribution to RBC~5 is the work by \mbox{%DIFAUXCMD
\citet[][hereafter C11]{2011AJ....141...61C} }\hspace{0pt}%DIFAUXCMD
,
subsequently updated by \mbox{%DIFAUXCMD
\citet[][hereafter CR16]{2016ApJ...824...42C}}\hspace{0pt}%DIFAUXCMD
.
}%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{C11 and CR16 }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet[][hereafter C11]{2011AJ....141...61C} }\hspace{0pt}%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citet[][hereafter CR16]{2016ApJ...824...42C}
}\hspace{0pt}%DIFAUXCMD
}\DIFaddend present a uniform set of spectroscopic observations \DIFdelbegin \DIFdel{calibrated
on the MW GCS }\DIFdelend of the inner 
$1.6^\circ~({\sim}21)$~kpc \DIFaddbegin \DIFadd{of M31 }\DIFaddend that is believed to be 94\% complete. \DIFdelbegin \DIFdel{GCs in }\DIFdelend \DIFaddbegin \DIFadd{In addition,
}\DIFaddend the outer stellar halo \DIFdelbegin \DIFdel{, }\DIFdelend \DIFaddbegin \DIFadd{of M31 }\DIFaddend up to $r_{\text{proj}}\sim150$~kpc \DIFdelbegin \DIFdel{, are }\DIFdelend \DIFaddbegin \DIFadd{is }\DIFaddend observed in 
the Pan-Andromeda Archaeological Survey \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep[PAndAS, ][hereafter H14]{2014MNRAS.442.2165H}}\hspace{0pt}%DIFAUXCMD
, but see also
\mbox{%DIFAUXCMD
\citet{2014MNRAS.442.2929V} }\hspace{0pt}%DIFAUXCMD
and \mbox{%DIFAUXCMD
\citet{2019MNRAS.484.1756M}}\hspace{0pt}%DIFAUXCMD
. H14 presents the discovery of 59 new GCs and publishes updates to RBC~5. The }\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep[PAndAS, ][hereafter H14]{2014MNRAS.442.2165H,
2014MNRAS.442.2929V, 2019MNRAS.484.1756M}}\hspace{0pt}%DIFAUXCMD
. In fact, 
the }\DIFaddend work of H14 is incorporated in the latest public release\footnote{Last 
revised 23 Sep 2015, see \url{https://www.cfa.harvard.edu/oir/eg/m31clusters/M31_Hectospec.html}}
of the C11 \DIFdelbegin \DIFdel{dataset, further revised by }\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend CR16 \DIFdelbegin \DIFdel{. We use }\DIFdelend \DIFaddbegin \DIFadd{data sets. Therefore we use the latest data set of }\DIFaddend CR16 
because it is the most recent aggregated dataset of M31's GCS that contains \DIFdelbegin \DIFdel{properties of interest
for our study and it includes }\DIFdelend GCs 
...
assumed $M/L_V = 2$ independent of [Fe/H]}. \DIFdelbegin \DIFdel{Radii are calculated from }\DIFdelend \DIFaddbegin \DIFadd{We calculate the galactocentric radii 
from the observed positions }\DIFaddend RA and DEC, \DIFaddbegin \DIFadd{as }\DIFaddend further discussed in \DIFdelbegin \DIFdel{Sec.}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:Rgc}.
...
in CR16. The mean age of the MW GCs in this data set is \DIFdelbegin \DIFdel{$11.9 \pm 0.1$}\DIFdelend \DIFaddbegin \DIFadd{$11.9$}\DIFaddend ~Gyr and the 
\DIFdelbegin \DIFdel{dispersion }\DIFdelend \DIFaddbegin \DIFadd{standard deviation }\DIFaddend is $0.8$~Gyr. Furthermore, only \DIFdelbegin \DIFdel{one }\DIFdelend \DIFaddbegin \DIFadd{1 }\DIFaddend of the 55 GC age-estimates is
below $10$~Gyr. The M31 GCS has a mean age of \DIFdelbegin \DIFdel{$11.0 \pm 0.2$}\DIFdelend \DIFaddbegin \DIFadd{$11.0$}\DIFaddend ~Gyr with a \DIFdelbegin \DIFdel{dispersion 
}\DIFdelend \DIFaddbegin \DIFadd{standard deviation 
}\DIFaddend of $2.2$~Gyr, and $24$ GCs have age-estimates below $10$~Gyr with a minimum age 
of $4.8$~Gyr. Based on these data, we find that the age distributions of the MW 
and M31 GCSs are not statistically consistent. \DIFdelbegin \DIFdel{Moreover, the }\DIFdelend \DIFaddbegin \DIFadd{The }\DIFaddend MW appears 
...
type than the MW \DIFdelbegin \DIFdel{meaning }\DIFdelend \DIFaddbegin \DIFadd{so }\DIFaddend that an older stellar population would \DIFdelbegin \DIFdel{be naively }\DIFdelend \DIFaddbegin \DIFadd{naively be }\DIFaddend expected.
...
$r_{\text{vir,MW}} = 261$~kpc to account for the different intrinsic sizes of \DIFdelbegin \DIFdel{both galaxies}\DIFdelend \DIFaddbegin \DIFadd{the two
galaxies, adopting the values and cosmology from \mbox{%DIFAUXCMD
\citet{2017MNRAS.464.3825P}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .
...
and \DIFaddbegin \DIFadd{the }\DIFaddend distance $D_{\text{M31}} = 780$~kpc \citep{2005MNRAS.356..979M,2012ApJ...758...11C}.
We \DIFdelbegin \DIFdel{calculate }\DIFdelend \DIFaddbegin \DIFadd{estimate }\DIFaddend $r_{\text{gal}}$ as `average deprojected distance`
...
(the halo GCs). We compare \DIFdelbegin \DIFdel{both }\DIFdelend \DIFaddbegin \DIFadd{the two }\DIFaddend distributions of the full data set (solid 
lines) and find that the MW has more GCs in the range $1-4$~kpc than M31
\DIFdelbegin \DIFdel{(}\DIFdelend when accounting for the larger number of total GCs in M31\DIFdelbegin \DIFdel{)}\DIFdelend . Interestingly, \DIFdelbegin \DIFdel{both
}\DIFdelend \DIFaddbegin \DIFadd{the two 
}\DIFaddend distributions show a similar trend for $r_{\text{gal}} > 4$~kpc and host a 
subpopulation of halo GCs. \DIFdelbegin \DIFdel{However, the two radial distributions }\DIFdelend \DIFaddbegin \DIFadd{Our naive expectation would be that the spiral galaxies
in the Local Group host similar GC systems. However, based on a two-sample KS test
we find that the radial distributions of the GCS of the MW and M31 }\DIFaddend are not statistically 
...
We show the two-dimensional mass-weighted \DIFdelbegin \DIFdel{metallicity-radial }\DIFdelend \DIFaddbegin \DIFadd{metallicity-radius }\DIFaddend distribution of the
...
\DIFaddend The observations indicate \DIFdelbegin \DIFdel{that
no }\DIFdelend \DIFaddbegin \DIFadd{very few }\DIFaddend GCs with high metallicities \DIFdelbegin \DIFdel{are to be expected }\DIFdelend at large radii (the three bins
in the upper right corner, both for MW and \DIFaddbegin \DIFadd{for }\DIFaddend M31), and relatively few GCs at large
radii in general ($r_{\text{gal}} > 30$~kpc; right column: $11$ GCs or 7.3\% in
the MW and $17$ or 4.6\% in M31). Moreover, \DIFdelbegin \DIFdel{the }\DIFdelend M31 hosts more metal-rich ([Fe/H]$ > -1$) 
GCs in each radial bin in comparison to the MW \DIFdelbegin \DIFdel{GCSs than what
would be expected when }\DIFdelend \DIFaddbegin \DIFadd{after }\DIFaddend accounting for the fact that M31
hosts a larger GCS\DIFdelbegin \DIFdel{than the MW}\DIFdelend . Finally, given that \DIFdelbegin \DIFdel{both }\DIFdelend \DIFaddbegin \DIFadd{the }\DIFaddend marginalized (i.e. the metallicity 
and radial) distributions are not statistically consistent \DIFaddbegin \DIFadd{between the two galaxies}\DIFaddend , 
we find that the two-dimensional distributions are also not consistent. More generally,
the GCS of the MW differs significantly from that of M31\DIFaddbegin \DIFadd{, not only in the number of 
clusters but also in their distribution over radius and metallicity}\DIFaddend . We compare these 
observations to the Auriga simulations \DIFdelbegin \DIFdel{later on in Sec.}\DIFdelend \DIFaddbegin \DIFadd{in Section}\DIFaddend ~\ref{sec:results_FeHRgc}.
...
\begin{figure}
    ...
    \caption{
        ...
        \DIFdelbeginFL \DIFdelFL{color-coded }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{colour-coded }\DIFaddendFL by the \textbf{median} (values also shown in each bin). The 
...
\mbox{%DIFAUXCMD
\citet{2017MNRAS.465.3622R}}\hspace{0pt}%DIFAUXCMD
. However, we caution that his definition, although 
...
\DIFdelbegin \DIFdel{when no additional selection criterion is 
applied). }\DIFdelend \DIFaddbegin \DIFadd{with no age cut). The mean number of star 
...
}\DIFaddend We further split the GC
...
was recorded), and an accreted subpopulation (those that have formed {\it ex~situ} \DIFdelbegin \DIFdel{and 
}\DIFdelend \DIFaddbegin \DIFadd{but
}\DIFaddend are bound to the most-massive halo/subhalo at $z=0$). A GC candidate either formed
{\it in~situ} or it was accreted. We consider the metallicity distribution in 
\DIFdelbegin \DIFdel{Sec.}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:results_FeH}, the distribution of galactocentric radii in 
\DIFdelbegin \DIFdel{Sec.}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:results_Rgc}, and the combination of \DIFdelbegin \DIFdel{both 
in Sec.}\DIFdelend \DIFaddbegin \DIFadd{the two 
in Section}\DIFaddend ~\ref{sec:results_FeHRgc}.
...
\begin{figure}
    ...
    \caption{
        ...
        \DIFaddbeginFL \DIFaddFL{The numbers in parenthesis show how many star particles are included 
        in the subset.
        }\DIFaddendFL \label{fig:Au4-10and21_FeH}
    }
\end{figure}
...
for specific behaviour, and to highlight that different runs \DIFdelbegin \DIFdel{could }\DIFdelend give rise to 
different distributions. We show the age-selected GC candidates as well as the 
accreted and {\it in~situ} subsets. 
The top \DIFdelbegin \DIFdel{half of the left figure }\DIFdelend \DIFaddbegin \DIFadd{panel of Figure~\ref{fig:Au4-10and21_FeH} }\DIFaddend shows the MW 
...
$0.0$ to $-0.6$. \DIFaddbegin \DIFadd{This reflects the enrichment history of the galaxy because the
age cut removes the more metal-rich stellar population which shifts the mean
metallicity towards lower values. }\DIFaddend Furthermore, accreted GC candidates generally have
lower mean metallicities than the {\it in~situ} subset with differences of roughly
...
\mbox{Au4-1} is undergoing a major merger at redshift zero and we find \DIFaddbegin \DIFadd{a mean
metallicity in this simulation }\DIFaddend $\mu = -1.51 \, ({-0.74})$ for the {\it in~situ} 
(accreted) GC candidates, although the former consists of only $1019$ particles 
($1.3$\% of all GC 
...
the accreted population is more \DIFdelbegin \DIFdel{metal rich}\DIFdelend \DIFaddbegin \DIFadd{metal-rich}\DIFaddend . After inspection of the same figure 
...
in Figure~\ref{fig:FeH_mu_sigma} to illustrate the \DIFaddbegin \DIFadd{individual }\DIFaddend behaviour for the 
full set of Auriga galaxies. The \DIFdelbegin \DIFdel{green }\DIFdelend \DIFaddbegin \DIFadd{beige }\DIFaddend crosses are to be compared to the purple 
\DIFdelbegin \DIFdel{(magenta ) cross, which shows }\DIFdelend \DIFaddbegin \DIFadd{and magenta crosses, which show }\DIFaddend the mean value of all MW \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend M31 \DIFdelbegin \DIFdel{) GCs}\DIFdelend \DIFaddbegin \DIFadd{GCs, respectively}\DIFaddend . 
In addition, we show the metal-rich \DIFdelbegin \DIFdel{(metal-poor) }\DIFdelend population of the MW GCS using a solid \DIFdelbegin \DIFdel{(open ) }\DIFdelend \DIFaddbegin \DIFadd{dot, 
and the metal-poor population with an open }\DIFaddend dot. We caution that
these literature values result from individual Gaussian fits to \DIFdelbegin \DIFdel{sub sets }\DIFdelend \DIFaddbegin \DIFadd{subsets }\DIFaddend of the 
...
[Fe/H]~$ = 1.5$. None of the Auriga \DIFdelbegin \DIFdel{sub sets }\DIFdelend \DIFaddbegin \DIFadd{subsets }\DIFaddend has a mean value that offers much 
hope \DIFdelbegin \DIFdel{that }\DIFdelend \DIFaddbegin \DIFadd{of reconciling }\DIFaddend the simulated distribution \DIFdelbegin \DIFdel{is consistent }\DIFdelend with the lowest metallicity 
...
mean values than \DIFdelbegin \DIFdel{what is }\DIFdelend observed for the MW and M31 GCS, and that we 
systematically find lower mean metallicities for the accreted GC candidates
than for those that have formed {\it in~situ}.

%DIF <  Finally, we test the null hypothesis that MW (M31) and the GC candidates (all,
...
\DIFdelend \begin{figure}
    ...
    \caption{
        ...
        age $>$~10~Gyr; \DIFdelbeginFL \DIFdelFL{green }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{beige }\DIFaddendFL solid). The latter \DIFdelbeginFL \DIFdelFL{sub set }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{subset }\DIFaddendFL is further split up
...
\end{figure}
We now turn to \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{our }\DIFaddend second goal, which is to see whether sufficient total mass in 
...
median \DIFdelbegin \DIFdel{for all thirty }\DIFdelend \DIFaddbegin \DIFadd{over all the $30$~}\DIFaddend Auriga L4 haloes \DIFdelbegin \DIFdel{with the $1\sigma$ interval around it 
...
conditions, thus, have \DIFdelbegin \DIFdel{unique merger histories)}\DIFdelend \DIFaddbegin \DIFadd{varying merger histories}\DIFaddend . We chose to aggregate the data 
...
candidates can `afford to lose' \DIFaddbegin \DIFadd{(}\DIFaddend due to a combination of smaller than unity bound
cluster formation efficiencies combined with a Hubble time of dynamical evolution\DIFaddbegin \DIFadd{)}\DIFaddend ,
while still producing sufficient mass at the right metallicities. In particular,
the \DIFdelbegin \DIFdel{cluster formation }\DIFdelend \DIFaddbegin \DIFadd{combined }\DIFaddend efficiency would have to \DIFdelbegin \DIFdel{decrease }\DIFdelend \DIFaddbegin \DIFadd{increase }\DIFaddend with decreasing 
...
metallicity. \DIFaddbegin \DIFadd{This trend could be consistent with the cluster formation efficiency 
model of \mbox{%DIFAUXCMD
\citet{2012MNRAS.426.3008K} }\hspace{0pt}%DIFAUXCMD
as lower metallicity star particles formed 
at earlier times when the bound cluster formation efficiencies are higher due
to higher pressure birth environments.
}\DIFaddend 
...
\begin{figure}
    \DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\columnwidth]{{LogRgc_mu_sigma-trim}.png}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=\columnwidth]{{LogRgc_median_sigma-trim}.png}
    \DIFaddendFL \caption{
        \DIFdelbeginFL \DIFdelFL{Mean }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Median }\DIFaddendFL and standard deviation of the logarithm of radial distribution 
        ...
        the galaxies.
        \DIFdelbeginFL %DIFDELCMD < \label{fig:Rgc_mu_sigma}
%DIFDELCMD <     %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:Rgc_median_sigma}
    \DIFaddendFL }
\end{figure}
...
in all Auriga L4 galaxies. Figure~\DIFdelbegin \DIFdel{\ref{fig:Rgc_mu_sigma} shows the mean }\DIFdelend \DIFaddbegin \DIFadd{\ref{fig:Rgc_median_sigma} shows the median }\DIFaddend and 
standard deviation of $\log_{10}(r_{\text{gal}})$ of star particles in all Auriga
L4 simulations\DIFaddbegin \DIFadd{, respectively}\DIFaddend . The purple \DIFdelbegin \DIFdel{(magenta ) cross again shows the mean }\DIFdelend \DIFaddbegin \DIFadd{and magenta cross show the median
}\DIFaddend of the MW \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend M31 \DIFdelbegin \DIFdel{)
...
}\DIFaddend dot now shows our calculation of the \DIFdelbegin \DIFdel{mean }\DIFdelend \DIFaddbegin \DIFadd{median }\DIFaddend value of the `red' metal-rich \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{population,
...
\begin{figure}
    ...
    \caption{
        ...
        L4 haloes. Here we consider only the GC candidates and \DIFdelbeginFL \DIFdelFL{color-code }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{colour-code }\DIFaddendFL by the 
...
Figure~\ref{fig:observations_FeHRgc}. \DIFaddbegin \DIFadd{We notice that the simulations produce
...
}\DIFaddend [Fe/H]\DIFdelbegin \DIFdel{$< -1.5$ and $3 < r_{\text{gal}}/\text{kpc} < 8$}\DIFdelend \DIFaddbegin \DIFadd{~$\in [-2.5, -1.5]$ and galactocentric radius $r_{\text{gal}}\in [3,8]$~kpc}\DIFaddend ,
for which the simulations produce 
a factor $10^{2.68}/10^{1.33} \approx 22$ and $10^{1.69}/10^{0.75} \approx 9$ 
more mass in GC candidates than \DIFdelbegin \DIFdel{what }\DIFdelend is observed in the MW and M31 respectively.
...
component, for [Fe/H] as well as for $r_\text{gal}$ \DIFaddbegin \DIFadd{as can be seen in Figure~\ref{fig:FeH}
and Figure~\ref{fig:Rgc}}\DIFaddend . The total mass excess in 
...
\DIFdelbegin \DIFdel{that are on }\DIFdelend \DIFaddbegin \DIFadd{which must have }\DIFaddend orbits with pericentres close to the galactic bulge or bar. In addition, 
...
\begin{figure}
    ...
    \caption{
        ...
        mass excess. The number in each bin shows the \DIFdelbeginFL \DIFdelFL{color-coded }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{colour-coded }\DIFaddendFL value that is 
...
from theoretical models. \DIFaddbegin \DIFadd{Moreover, disrupted dwarf galaxies are more likely to 
contribute to the build up of the stellar halo than GCs \mbox{%DIFAUXCMD
\citep[e.g.][]{2015MNRAS.448L..77D, 
2019ApJ...887..237C}}\hspace{0pt}%DIFAUXCMD
. }\DIFaddend Overall, our set of GC candidates most likely contains
an overabundance of regular stars. It could be that the resulting metallicity
distribution is then biased towards higher values than \DIFdelbegin \DIFdel{what is }\DIFdelend observed for real 
GCs. An alternative explanation could overmixing of metals at early times.


In general, the colour (metallicity) distribution of most GCSs \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{appears to be }\DIFaddend bimodal 
...
that the mean metallicity shifts when we split the GC candidates \DIFdelbegin \DIFdel{up }\DIFdelend according 
...
On the other hand, we also notice that \DIFdelbegin \DIFdel{a substantial number of simulations has similar 
mean values }\DIFdelend \DIFaddbegin \DIFadd{most of the simulations have a similar 
mean value }\DIFaddend for all GC candidates, and the simulated {\it in~situ} GC candidates 
have larger dispersions than \DIFdelbegin \DIFdel{the }\DIFdelend \DIFaddbegin \DIFadd{is claimed for }\DIFaddend metal-rich GCs \DIFaddbegin \DIFadd{in the MW}\DIFaddend . Moreover, the 
offset between the \DIFdelbegin \DIFdel{mean }\DIFdelend \DIFaddbegin \DIFadd{means }\DIFaddend of the metal-rich and metal-poor populations in the MW is
$1$ dex, a factor $2-3$ larger than the offset that we find between the {\it in~situ}
and accreted populations. \DIFdelbegin \DIFdel{The Auriga simulations therefore do not support the view 
that the metal-poor GCs could have only formed in satellites that have later been 
accreted whereas the metal-rich GC subpopulation has only formed }%DIFDELCMD < {\it %%%
\DIFdel{in~situ}%DIFDELCMD < }%%%
\DIFdel{. 
With this statement, however, we do }\DIFdelend \DIFaddbegin \DIFadd{However, we }\DIFaddend caution that \citet{2019MNRAS.486.3134K} suggests 
...
GC candidates would have to be lower \DIFaddbegin \DIFadd{Alternatively, the fraction of old star 
...
during hierarchical buildup of the galaxy}\DIFaddend . Our classification \DIFdelbegin \DIFdel{as }\DIFdelend \DIFaddbegin \DIFadd{of }\DIFaddend GC candidates 
could \DIFdelbegin \DIFdel{especially }\DIFdelend be improved for the accreted subset \DIFaddbegin \DIFadd{in particular}\DIFaddend . For example, we could 
\DIFdelbegin \DIFdel{tag }\DIFdelend \DIFaddbegin \DIFadd{select }\DIFaddend only a subset of the accreted star particles as GC candidates \DIFdelbegin \DIFdel{, }\DIFdelend where the 
number number of GCs \DIFdelbegin \DIFdel{is }\DIFdelend \DIFaddbegin \DIFadd{would be }\DIFaddend determined by the satellite halo mass, given the 
$M_{vir}-N_{\text{gal}}$ correlation found by \citet{2019arXiv190100900B}. \DIFaddbegin \DIFadd{However,
we did not include such an analysis in this study.
}\DIFaddend 

%DIF <  Copy-pasted from \citet{2019MNRAS.486.5838R}
%DIF <  ``Out of the cluster formation models considered, the `no formation physics' model,
%DIF <  in which both the CFE and the ICMF are fixed throughout cosmic time, is
%DIF <  approximately equivalent to those studies  that  use  `particle-tagging'
%DIF <  techniques  to  identify  GCs  in cosmological simulations (e.g. Tonini 2013,
%DIF <  Renaud et al. 2017). We find that this cluster formation model continues to form GCs
%DIF <  at a vigorous rate until the present time, which implies it overproduces
%DIF <  the total GC mass in the MW by a factor
%DIF <  5.5 relative to the mass formed in the fiducial model. Likewise, the continued
%DIF <  formation  of  GCs  in  this  model  predicts  the  on-going  formation
%DIF <  of massive (M $>10^5$ M\Sun) clusters with [Fe/H]$ <-0.5$ should be observed in
%DIF <  MW-mass galaxies at $z=0$. For these reasons, an environmentally independent
%DIF <  cluster formation description is not compatible with observations.''
...
\mbox{%DIFAUXCMD
\citep[e.g.][]{2018RSPSA.47470616F}}\hspace{0pt}%DIFAUXCMD
...
\DIFaddbegin \DIFadd{We find that including more recently formed star particles in our subset 
...
a metallicity below }[\DIFadd{Fe/H}]\DIFadd{~=~-1 more recent than 6 Gyr ago: the behaviour of 
Figure~\ref{fig:FeH} does not change for metallicities below }[\DIFadd{Fe/H}]\DIFadd{~=~-1 when 
we change the age cut to 8 or 6 Gyr, and the slope of the masss ratio for 
metallicities above }[\DIFadd{Fe/H}]\DIFadd{~=~-1 is slightly steeper. In addition, we still find
that the accreted GC candidates are more metal-poor than those that have formed 
}{\it \DIFadd{in~situ}}\DIFadd{. 
}

\DIFadd{The qualitative behaviour of the median distribution of galactocentric radii 
...
GC candidates is not affected definition because our selection
function mostly includes star particles that have formed before roughly $z=2$.
...
Auriga simulations and compare the simulations to the MW and M31 GCSs \DIFaddbegin \DIFadd{to test
...
observed GC systems}\DIFaddend . Based on our analysis we draw the following conclusions.
...
\begin{itemize}
    ...
    to the main subhalo \DIFdelbegin \DIFdel{in the main }\DIFdelend \DIFaddbegin \DIFadd{of the }\DIFaddend halo. The total mass of GC candidates is 
...
}\DIFaddend This work has been supported by the European Research Council under ERC-StG grant
...
from \citet{2015arXiv150903700K} for two-dimensional plots. \DIFaddbegin \DIFadd{This research 
...
% \clearpage
% \appendix
%DIF <  \section{Scatter between individual Auriga haloes, and numerical convergence}
%DIF <  \label{sec:scatter-convergence}
%DIF <  We check whether the properties of the Auriga globular cluster candidates
%DIF <  are well converged between the three different resolution levels used for the
%DIF <  Auriga simulations. Here we consider all three Auriga haloes for which simulation
%DIF <  runs were performed at all three resolution levels: Au6, Au16, and Au24. Here
%DIF <  we can investigate differences between individual haloes.
%DIF <  
%DIF <  Figure~\ref{fig:logMFeH_res} shows the mass-weighted metallicity distribution,
%DIF <  Figure~\ref{fig:logMRgc_res} shows the mass-weighted radial distribution, and
%DIF <  Figure~\ref{fig:logMRgcFeH_res}
%DIF <  
%DIF <  
%DIF <  
%DIF <  \begin{figure*}
%DIF <      \includegraphics[width=0.31\textwidth]{{logMFeH_Au6}.png}
%DIF <      \includegraphics[width=0.31\textwidth]{{logMFeH_Au16}.png}
%DIF <      \includegraphics[width=0.31\textwidth]{{logMFeH_Au24}.png}
%DIF <      \caption{Similar to Figure~\ref{fig:FeH}, but showing one individual Auriga
%DIF <          halo, where colours indicate the resolution level: L3 green, L4 orange,
%DIF <          and L5 blue. \emph{Left:} Auriga halo 6. \emph{Mid:} Auriga halo 16.
%DIF <          \emph{Right:} Auriga halo 24. For all three haloes we find marginal
%DIF <          increases in the mass normalization with increasing resolution level.
%DIF <          \label{fig:logMFeH_res}
%DIF <      }
%DIF <  
%DIF <  \end{figure*}
%DIF <  \begin{figure*}
%DIF <      \includegraphics[width=0.31\textwidth]{{logMRgc_Au6}.png}
%DIF <      \includegraphics[width=0.31\textwidth]{{logMRgc_Au16}.png}
%DIF <      \includegraphics[width=0.31\textwidth]{{logMRgc_Au24}.png}
%DIF <      \caption{Similar to Figure~\ref{fig:Rgc}, but showing one individual Auriga
%DIF <          halo, where colours indicate the resolution level: L3 green, L4 orange,
%DIF <          and L5 blue. \emph{Left:} Auriga halo 6. \emph{Mid:} Auriga halo 16.
%DIF <          \emph{Right:} Auriga halo 24. For all three haloes we find marginal
%DIF <          increases in the mass normalization with increasing resolution level.
%DIF <          \label{fig:logMRgc_res}
%DIF <      }
%DIF <  
%DIF <  \end{figure*}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
