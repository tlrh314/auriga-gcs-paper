...
%DIF ADD AurigaGCS.tex            Mon Dec  9 17:41:31 2019
%
...
\citep[values from][page~38]{1998gcs..book.....A}}\hspace{0pt}%DIFAUXCMD
        ...
        }[\DIFaddFL{Fe/H}] \DIFaddFL{= -1 as indicated by the vertical dotted magenta line)}\DIFaddendFL .
...
galaxies. The \DIFdelbegin \DIFdel{green }\DIFdelend \DIFaddbegin \DIFadd{beige }\DIFaddend crosses are to be compared to the purple (magenta) cross, 
...
median for all thirty Auriga L4 haloes with the \DIFdelbegin \DIFdel{$1\sigma$ interval around it 
}\DIFdelend \DIFaddbegin \DIFadd{25-75 percentile range 
}\DIFaddend (shaded regions, which shows the scatter between runs that have different initial 
...
GCs (which are to be compared to the \DIFdelbegin \DIFdel{green }\DIFdelend \DIFaddbegin \DIFadd{beige }\DIFaddend crosses), but solid (open) dot now
