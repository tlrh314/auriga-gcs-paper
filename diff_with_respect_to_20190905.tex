...
%DIF ADD AurigaGCS.tex            Tue Apr  7 14:00:27 2020
%
...
MW \DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{and the }\DIFaddend M31 \DIFdelbegin \DIFdel{) }\DIFdelend GCS in the top \DIFdelbegin \DIFdel{(bottom ) }\DIFdelend \DIFaddbegin \DIFadd{and bottom }\DIFaddend panel of Figure~\ref{fig:observations_FeHRgc}\DIFaddbegin \DIFadd{,
respectively}\DIFaddend . The observations indicate that
...
.
}\DIFdelend \DIFaddbegin \DIFadd{adopting the definition of 
\mbox{%DIFAUXCMD
