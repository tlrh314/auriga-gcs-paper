...
%DIF DEL AurigaGCS_20190905.tex   Mon Sep  9 16:29:17 2019
%DIF ADD AurigaGCS.tex            Wed Dec  4 15:15:33 2019
%
...
biased dark matter \DIFaddbegin \DIFadd{(DM) }\DIFaddend halos at high redshift. Other recent hypotheses of GC formation 
...
and of the M31 GCS in \DIFdelbegin \DIFdel{Sec.}\DIFdelend \DIFaddbegin \DIFadd{Section}\DIFaddend ~\ref{sec:andromeda}
...
\begin{figure}
    ...
    \caption{
        ...
        \DIFdelbeginFL \DIFdelFL{candicates }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{candidates }\DIFaddendFL in green, and use a green dotted line for all star particles. 
...
The lowest mass surplus for both galaxies is the \DIFdelbegin \DIFdel{the }\DIFdelend bin where $-2.5 <$ [Fe/H] 
...
\begin{itemize}
    ...
    star particles in the Auriga simulations are not consistent with GCS of the 
    Milky Way or with that of the Andromeda galaxy.
}
