...
%DIF ADD AurigaGCS.tex            Sun Aug 18 18:25:44 2019
%
...
\DIFdelbegin \DIFdel{mass-excess for different $R_{\text{GC}}$}\DIFdelend \DIFaddbegin \DIFadd{mass-ratio for different galactocentric radius-metallicity 
($R_{\text{gal}}$}\DIFaddend -[Fe/H]\DIFdelbegin \DIFdel{bins}\DIFdelend \DIFaddbegin \DIFadd{) bins of simulated GC candidates
relative to the observed mass in the MW and M31 GC systems}\DIFaddend . This implies different 
...
the distribution of \DIFdelbegin \DIFdel{galactocentric radius}\DIFdelend \DIFaddbegin \DIFadd{$R_{\text{gal}}$ }\DIFaddend . Overall, the Auriga simulations produce 
