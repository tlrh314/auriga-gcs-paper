...
%DIF DEL AurigaGCS_20190802.tex   Sun Aug 18 18:21:19 2019
%DIF ADD AurigaGCS.tex            Mon Aug 19 16:11:38 2019
%
...
The \DIFdelbegin \DIFdel{interstellar medium is modelled using a sub-grid approach which implements
...
%DIFDELCMD < %%%
\DIFdel{The sub-grid }\DIFdelend \DIFaddbegin \DIFadd{galaxy formation model }\DIFaddend includes primordial and metal-line cooling with 
...
\DIFdelendFL \DIFaddbeginFL \emph{\DIFaddFL{Top}}\DIFaddFL{: }\DIFaddendFL Metallicity distribution of \DIFdelbeginFL \DIFdelFL{Au4-10 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the MW and M31 GCS. The solid 
        purple }\DIFaddendFL (\DIFdelbeginFL \DIFdelFL{bottom panel}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{magenta) line shows the GC system of the MW (M31}\DIFaddendFL )\DIFaddbeginFL \DIFaddFL{, and we 
...
mass in the MW (M31) GCS to obtain the median mass \DIFdelbegin \DIFdel{excess }\DIFdelend \DIFaddbegin \DIFadd{ratio }\DIFaddend produced by the star
formation model implemented in the Auriga simulations. See the top (bottom) panel
of Figure~\ref{fig:Au-FeHRgc-ratio} for mass \DIFdelbegin \DIFdel{excess }\DIFdelend \DIFaddbegin \DIFadd{ratio }\DIFaddend with respect to the MW (M31) GCS.
...
simulations, in contrast to the observations. }\DIFdelend The top panel of Figure~\ref{fig:Au-FeHRgc-ratio} shows that the mass \DIFdelbegin \DIFdel{excess }\DIFdelend \DIFaddbegin \DIFadd{ratio }\DIFaddend for 
...
\begin{figure}
    ...
    \caption{
        ...
        the median value of these 25 bins}\DIFaddendFL . The \DIFdelbeginFL \DIFdelFL{color-coded }\DIFdelendFL values are \DIFdelbeginFL \DIFdelFL{also shown }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{2.68 and 1.69 for the
        MW and M31, respectively. Red (blue) indicates a higher (lower) overall 
