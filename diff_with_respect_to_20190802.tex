...
%DIF ADD AurigaGCS.tex            Mon Aug 19 18:15:58 2019
%
...
Globular clusters (GC)s are old, bright, \DIFdelbegin \DIFdel{ubiquitous, and various }\DIFdelend \DIFaddbegin \DIFadd{and ubiquitous. Various }\DIFaddend properties of
...
}\DIFaddend compared to observations of the Milky Way globular cluster system.
...
galaxies \DIFaddbegin \DIFadd{(Milky Way analogues) }\DIFaddend at redshift zero for which several global properties 
...
the star formation histories of the simulations \DIFdelbegin \DIFdel{(also) }\DIFdelend give rise to a GC system 
...
high-resolution cosmological zoom simulations\DIFdelbegin \DIFdel{of }\DIFdelend \DIFaddbegin \DIFadd{. The }\DIFaddend Milky Way-mass
selected initial conditions \DIFaddbegin \DIFadd{were selected from the \mbox{\textsc{eagle}} DM only 
box, see \mbox{%DIFAUXCMD
\citetalias{2017MNRAS.467..179G} }\hspace{0pt}%DIFAUXCMD
for details}\DIFaddend . The simulations are performed with the \textsc{arepo} 
...
\DIFdelbegin \DIFdel{systems of the Milky Way and that of Andromeda both differ significantly}\DIFdelend \DIFaddbegin \DIFadd{system of the MW differs significantly from that of M31}\DIFaddend . We compare these 
...
distributions consistent with the MW and M31 GC systems, and whether
...
\DIFdelendFL \DIFaddbeginFL \emph{\DIFaddFL{Top}}\DIFaddFL{: }\DIFaddendFL Metallicity distribution of \DIFdelbeginFL \DIFdelFL{Au4-10 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{the MW and M31 GCS. The solid 
        purple }\DIFaddendFL (\DIFdelbeginFL \DIFdelFL{bottom panel}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{magenta}\DIFaddendFL ) \DIFaddbeginFL \DIFaddFL{line shows the GC system of the MW (M31), and we 
...
\DIFdelbegin \DIFdel{(}\DIFdelend \DIFaddbegin \DIFadd{and }\DIFaddend M31 \DIFdelbegin \DIFdel{) GC system in purple (magenta)}\DIFdelend \DIFaddbegin \DIFadd{GC systems}\DIFaddend , where we overplot a double Gaussian for the MW GCS \DIFdelbegin \DIFdel{(the purple dashed lines) }\DIFdelend by 
...
(sub)populations of GC candidates that are more metal-rich than the MW and M31 GC 
systems. Moreover, none of the simulations has a \DIFaddbegin \DIFadd{(total) }\DIFaddend population of GC 
...
galaxies, particularly around [Fe/H]~$=-1$. In addition, Andromeda does host 
...
$10$~kpc. Again we show the mass \DIFdelbegin \DIFdel{excess }\DIFdelend \DIFaddbegin \DIFadd{ratio }\DIFaddend of the simulations compared to the Milky
Way and Andromeda GCS. We find a decreasing mass \DIFdelbegin \DIFdel{excess }\DIFdelend \DIFaddbegin \DIFadd{ratio }\DIFaddend with increasing radius
...
and M31 GC systems. 
\DIFdelbegin \DIFdel{However, the three bins in the upper right corner are populated in the Auriga
simulations , in contrast to the observations. The top }\DIFdelend \DIFaddbegin 
...
in each bin). We show this in the top (bottom) }\DIFaddend panel of Figure~\ref{fig:Au-FeHRgc-ratio}\DIFdelbegin \DIFdel{shows that the mass excess for }\DIFdelend \DIFaddbegin \DIFadd{.
...
have been zero. Red and blue values indicate deviations from such as scenario and
indicate a higher (lower) than average mass excess. In particular, the median 
...
\DIFaddend Auriga GCs within the Solar radius decreases with decreasing metallicity. This
...
(resolution) consistent with that of GCs, they are in fact statistical tracers 
...
that all halo stars come from disrupted GCs because \DIFdelbegin \DIFdel{GC systems that survive down to redshift zero are generally }\DIFdelend \DIFaddbegin \DIFadd{the total mass in GC systems 
...
populations of GC systems at [Fe/H]~=~$-1$\DIFaddbegin \DIFadd{, as for the MW}\DIFaddend . Moreover, we do find 
