...
%DIF ADD AurigaGCS.tex            Mon Aug 19 12:48:41 2019
%
...
than the old {\it in~situ} stars with differences of roughly ${\sim}0.3$ for the majority 
...
is reversed for \mbox{Au4-1} and \mbox{Au4-4} for which the old {\it in~situ} population 
...
for the old {\it in~situ} (accreted) although the former consists of only $1019$ 
particles ($1.3$\% of all GC candidates, and with a total mass of 5e7 M\Sun). 
For \mbox{Au4-4}, ${10.8}$\% of the GC candidates is classified as {\it in~situ} (compared 
to {\it in~situ} fractions of ${40-80}$\% for other haloes). After inspection of
the same figure for every one of the thirty Auriga L4 haloes we find that the 
...
\begin{figure}
    ...
    \caption{
        ...
        [red] crosses show the values calculated using the old (old {\it in~situ})
...
The mass budget of the old stars is dominated by the old {\it in~situ} population (blue 
...
mass \DIFdelbegin \DIFdel{excess }\DIFdelend \DIFaddbegin \DIFadd{ratio }\DIFaddend up to $-0.9$, above which the simulations produce a higher mass \DIFdelbegin \DIFdel{excess 
...
metal-rich/metal-poor groups by taking a metallicity cut at [Fe/H]~=~-1 as is 
...
\begin{figure}
    ...
    \caption{
        ...
        to mass in the MW (M31) GCS, i.e. the logarithm of the mass \DIFaddbeginFL \DIFaddFL{ratio, minus
        the median value. This way red indicates regions of with a higher mass
        }\DIFaddendFL excess \DIFaddbeginFL \DIFaddFL{than the median, conversely blue highlights bins with a lower than
        median mass ratio}\DIFaddendFL . The \DIFdelbeginFL \DIFdelFL{color-coded values are also shown }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{number }\DIFaddendFL in each bin \DIFaddbeginFL \DIFaddFL{shows the color-coded value 
        that is plotted, and the (median) star particle count is given in 
        parenthesis}\DIFaddendFL . Note that the three bins in the upper right corner are \DIFdelbeginFL \DIFdelFL{left blank }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{white
        }\DIFaddendFL because the observations have zero mass there\DIFdelbeginFL \DIFdelFL{, and that the numbers indicate how much (median) mass is
