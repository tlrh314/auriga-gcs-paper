...
%DIF DEL AurigaGCS_20190802.tex   Wed Aug 14 10:45:39 2019
%DIF ADD AurigaGCS.tex            Sun Aug 18 16:48:32 2019
%
...
\begin{figure}
    ...
    \caption{
        ...
        to mass in the MW (M31) GCS, i.e. the logarithm of the mass \DIFdelbeginFL \DIFdelFL{excess}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{ratio}\DIFaddendFL . The
        \DIFdelbeginFL \DIFdelFL{color-coded values are also shown }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{number }\DIFaddendFL in each bin \DIFaddbeginFL \DIFaddFL{shows the color-coded value that is plotted, and the
        (median) star particle count is given in parenthesis}\DIFaddendFL . Note that the three 
        bins in the upper right corner are left blank because the observations
        have zero mass there\DIFdelbeginFL \DIFdelFL{, and that the numbers indicate how much (median) mass is
