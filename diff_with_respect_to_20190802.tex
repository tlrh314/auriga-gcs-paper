...
%DIF ADD AurigaGCS.tex            Wed Aug 14 11:08:38 2019
%
...
mass-excess for different $R_{\text{GC}}$-[Fe/H] bins \DIFaddbegin \DIFadd{of simulated GC candidates
...
standard deviation of $\log_{10}(R_{\text{GC}})$ of star particles in all Auriga
...
we find that the simulations have a wider dispersion in $\log(R_{\text{GC}}$ than
