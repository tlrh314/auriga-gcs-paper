...
%DIF DEL AurigaGCS_20200513.tex   Tue Jun  2 13:51:59 2020
%DIF ADD AurigaGCS.tex            Tue Jun  2 14:05:48 2020
%
...
\citep{2019arXiv190408941C}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{2019ApJ...878L..23C}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend , or in high-speed collisions of dark matter subhaloes
\DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{2019arXiv190508951M}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{2020ApJ...890...18M}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . \citet{2017MNRAS.472.3120B} suggests
...
produces star clusters that could be GC progenitors \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{
2019arXiv190509840L}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{2019ApJ...879L..18L}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend .
...
simulations \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citep{2010ApJ...718.1266M,2014ApJ...796...10L,2018MNRAS.480.2343C,
2019MNRAS.486..331C,2019arXiv190505199C}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citep{2010ApJ...718.1266M,2014ApJ...796...10L,2018MNRAS.480.2343C,
2019MNRAS.486..331C,2019MNRAS.488.5409C}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend , also done in the work by 
...
\citet[][section~4.1]{2019A&A...623A..65W} 
}\hspace{0pt}%DIFAUXCMD
...
$M_{vir}-N_{\text{gal}}$ correlation found by \DIFdelbegin \DIFdel{\mbox{%DIFAUXCMD
\citet{2019arXiv190100900B}}\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\citet{2020AJ....159...56B}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . However,
...
The analysis in this work was performed using the \DIFdelbegin \DIFdel{Python }\DIFdelend \DIFaddbegin \textsc{\DIFadd{python}} \DIFaddend \citep{python}
programming language, the \DIFdelbegin \DIFdel{IPython }\DIFdelend \DIFaddbegin \textsc{\DIFadd{ipython}} \DIFaddend \citep{2007CSE.....9c..21P} environment, 
the \DIFdelbegin \DIFdel{NumPy \mbox{%DIFAUXCMD
\citep{2011CSE....13b..22V}}\hspace{0pt}%DIFAUXCMD
, SciPy \mbox{%DIFAUXCMD
\citep{scipy}}\hspace{0pt}%DIFAUXCMD
, and Astropy 
}\DIFdelend \DIFaddbegin \textsc{\DIFadd{numpy}} \DIFadd{\mbox{%DIFAUXCMD
\citep{2011CSE....13b..22V}}\hspace{0pt}%DIFAUXCMD
, }\textsc{\DIFadd{scipy}} \DIFadd{\mbox{%DIFAUXCMD
\citep{2020SciPy-NMeth}}\hspace{0pt}%DIFAUXCMD
, and }\textsc{\DIFadd{astropy}}
\DIFaddend \citep{2013A&A...558A..33A} packages. Plots were created with \DIFdelbegin \DIFdel{Matplotlib 
}\DIFdelend \DIFaddbegin \textsc{\DIFadd{matplotlib}}
\DIFaddend \citep{2007CSE.....9...90H}, using the perceptually uniform colour maps
