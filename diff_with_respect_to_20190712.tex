...
%DIF ADD AurigaGCS.tex            Thu Aug  1 19:04:39 2019
%
...
\begin{figure}
    ...
    \DIFaddbeginFL \includegraphics[width=\columnwidth]{{MW_M31_Rgc_Histogram}.png}
    \DIFaddendFL \caption{
        \DIFaddbeginFL \emph{\DIFaddFL{Top}}\DIFaddFL{: }\DIFaddendFL Age distribution of 55 GCs in the MW
        \citep[data from][]{2013ApJ...775..134V} and 88 GCs
        in M31 \citep[data from][]{2016ApJ...824...42C}.
        \DIFaddbeginFL \emph{\DIFaddFL{Bottom:}} \DIFaddFL{Distribution of galactocentric radius in the MW and M31.
        The dotted lines show the subset of data that also have age measurements
        (i.e. the same sample as used in the top panel).
        }\DIFaddendFL \label{fig:MW-M31-age}
    }
\end{figure}
...
to \DIFdelbegin \DIFdel{insitu }\DIFdelend \DIFaddbegin {\it \DIFadd{in~situ}} \DIFaddend fractions of ${40-80}$\% for other haloes). Overall we find that the 
...
simulations. We notice that the old \DIFdelbegin \DIFdel{insitu }\DIFdelend \DIFaddbegin {\it \DIFadd{in~situ}} \DIFaddend populations are more centrally 
...
first have to migrate inwards in order to populate the innermost radii. 
\DIFdelbegin \DIFdel{Moreover, 
we notice that the dispersion increases with increasing mean value of the radial 
distribution as may be expected for a non-negative quantity. }\DIFdelend %DIF >  Moreover, 
%DIF >  we notice that the dispersion increases with increasing mean value of the radial 
%DIF >  distribution as may be expected for a non-negative quantity. 
The purple (magenta)
...
the Auriga simulations. The larger radial \DIFdelbegin \DIFdel{extend }\DIFdelend \DIFaddbegin \DIFadd{extent }\DIFaddend of the M31 GCS is generally
...
Figure~\ref{fig:Au-FeHRgc-ratio}) shows a less clear \DIFdelbegin \DIFdel{trent }\DIFdelend \DIFaddbegin \DIFadd{trend }\DIFaddend than for the Milky Way. 
...
\begin{itemize}
    ...
    old accreted or the old \DIFdelbegin \DIFdel{insitu }\DIFdelend \DIFaddbegin {\it \DIFadd{in~situ}} \DIFaddend star particles. In addition, this is also
    ...
    metal-rich GCs formed \DIFdelbegin \DIFdel{insitu }\DIFdelend \DIFaddbegin {\it \DIFadd{in~situ}} \DIFaddend and that all metal-poor GCs were accreted.
