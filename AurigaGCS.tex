...
see][for a review]{2010ARA&A..48..431P}, observable in the local Universe in great
detail, also governs GC formation at high redshifts. In this framework, differences
...
high-resolution hydrodynamical cosmological zoom simulations. \citet{
2016ApJ...831..204R} run parsec scale simulations of the high-redshift universe 
...
In this work we use state of the art simulations that produce realistic 
spiral galaxies at redshift zero that reproduce a number of observables. Therefore
the question naturally arises whether the simulations (also) yield a population 
of star particles that is consistent with the Milky Way and/or Andromeda globular 
cluster systems. In particular, we investigate the Auriga suite of cosmological 
zoom simulations (\citealt{2017MNRAS.467..179G}, and described in 
Sec.~\ref{sec:auriga}) which can serve as an ultimate test of the star formation 
model implemented in these simulations. The plan of the paper is as follows. We
summarise the relevant characteristics of the Auriga simulations in
