...
% Referee: ``\citet{2012MNRAS.426.1475U} shows the great variety in GC metallicity distributions
...
when no additional selection criterion is applied). The mean number of star 
...
metallicity in this simulations $\mu = -1.51 \, ({-0.74})$ for the {\it in~situ} 
...
and magenta cross, which shows the mean value of all MW and M31 GCs, respectively. 
...
accreted populations. However, we caution that \citet{2019MNRAS.486.3134K} suggests 
...
radially extended halo GC population. Our classification of accreted GC candidates
