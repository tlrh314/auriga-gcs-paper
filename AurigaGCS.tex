...
of the MW GC system \citep[e.g.][]{2018A&A...616A..12G, 2018ApJ...859L..13B,
2019A&A...621A..56P, 2019MNRAS.484.2832V}. Moreover, the visbility and ubiquity
of GCs makes it possible to obtain integrated properties of GCs within the Local 
Group with reasonable certainty, and even beyond the Local Group \citep[e.g.][]{1991ARA&A..29..543H}.
...
One important ingredient for plausible formation mechanisms comes from observed 
bimodality in the colour distribution, believed to be indicative of bimodality
in the underlying metallicity distribution of GC systems. GCs in the MW can 
be split up into a metal-rich (red) disk, and a metal-poor (blue) halo
(sub)population. The exact dividing value slightly differs between authors,
e.g. [Fe/H]~$=-0.8$ \citep[according to][]{1985ApJ...293..424Z}, or
...
2006ApJ...639...95P}. It has long been debated whether the Andromeda GCS metallicity 
distribution is uni- bi- or multimodal, with \citet{2016ApJ...824...42C} recently
arguing that the data favours three groups (split at [Fe/H] $= -0.4$ and $-1.5$)
after more accurate age-measurements improved classification of star clusters
as globular (or otherwise).

The literature offers several formation scenarios. 
