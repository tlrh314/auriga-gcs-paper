...
Overall, the Auriga simulations produce GC candidates with higher metallicities 
...
high-resolution cosmological zoom simulations. The Milky Way-mass
selected initial conditions were selected from the \mbox{\textsc{eagle}} DM only 
box, see \citetalias{2017MNRAS.467..179G} for details. The simulations are performed with the \textsc{arepo} 
code \citep{2010MNRAS.401..791S, 2016MNRAS.455.1134P} that solves the 
...
\begin{figure}
    ...
    \caption{
        ...
        (i.e. the same sample as in the top panel).
...
system of the MW differs significantly from that of M31. We compare these 
...
\begin{figure}
    ...
    \caption{
        ...
        purple (magenta) line shows the GC system of the MW (M31), and we 
...
and M31 GC systems, where we overplot a double Gaussian for the MW GCS by 
...
systems. Moreover, none of the simulations has a (total) population of GC 
candidates with a bimodal metallicity distribution.
...
$10$~kpc. Again we show the mass ratio of the simulations compared to the Milky
Way and Andromeda GCS. We find a decreasing mass ratio with increasing radius
...
Figure~\ref{fig:observations_FeHRgc}). We notice that the Auriga simulations, 
...
To ease the comparison between the simulations and observations we take the ratio
...
The top panel of Figure~\ref{fig:Au-FeHRgc-ratio} shows that mass excess for
...
that all halo stars come from disrupted GCs because the total mass in GC systems 
...
populations of GC systems at [Fe/H]~=~$-1$, as for the MW. Moreover, we do find 
...
be consistent with the MW or M31 GCS.
