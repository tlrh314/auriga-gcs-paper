...
We find that the age cut lowers the mean metallicity from \textasciitilde{}$0.0$
to \textasciitilde{}$-0.6$.
...
we find a constant mass excess up to \textasciitilde{}$-0.9$, above which the 
...
for a quantity that cannot have negative values. 
...
of Figure~\ref{fig:Au-FeHRgc} for mass excess with respect to the MW (M31) GCS.
