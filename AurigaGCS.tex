...
% Rosenblatt+ 1988, Cen 2001, Bromm \& Clarke 2002, Diemand+ 2002, Moore+ 2006,
% Boley+ 2009, Griffen+ 2010, Trenti+ 2015, Kimm+ 2016, Ricotti+ 2016, Boylan-Kolchin 2017,
% Creasey+ 2019.

We now turn to recent studies that focus on the hypothesis that the physical 
processes responsible for the formation of young massive clusters (YMC)s (observable)
in the local Universe also governs GC formation at high redshifts and differences
between both classes of objects are caused by nearly a Hubble time of (dynamical)
evolution. This picture is based on observed similarities between YMCs and GCs
\citep[e.g.][]{1992AJ....103..691H}, % Schweizer+ 1996, Whitmore+ 1999, Bastian+ 2006
...
GC progenitors at times of formation (Vanzella et al. 2017; Johnson et al. 2017).
Early modelling work by \citet{2015MNRAS.454.1658K} is now incorporated into
cosmological zoom simulations and shows promising results
\citep{2018MNRAS.475.4309P,2019MNRAS.486.3134K}.

Recent studies by other groups also incorporate formation of (globular) star 
clusters into cosmological zoom simulations.
\todo[inline]{
Cosmological Galform simulations (e.g. Oser et al. 2010; Cook et al. 2016; 
Rodriguez-Gomez et al. 2016), in situ vs. ex situ, particle tagging.}

\citep{2005ApJ...623..650K}
\citep{2016ApJ...831..204R}
\citep{2017ApJ...834...69L}
\citep{2017MNRAS.465.3622R}
\citep{2018MNRAS.474.4232K}
\citep{2018MNRAS.475.4309P,2019MNRAS.486.3134K}

\citep{2010ApJ...718.1266M,2014ApJ...796...10L,2018MNRAS.480.2343C,
2019MNRAS.486..331C,2019arXiv190505199C}

% bimodality in the broad-band colours of many (perhaps most) GC systems (e.g.
% Zepf & Ashman 1993; Elson, Santiago & Gilmore 1996; Geisler,
% Lee & Kim 1996; Forbes, Brodie & Huchra 1997a; Gebhardt &
% Kissler-Patig 1999; Kundu & Whitmore 2001; Larsen et al. 2001).
...
Milky Way (MW) and Andromeda globular cluster system (GCS) in
section~\ref{sec:observations} that we use to compare our simulations to in
