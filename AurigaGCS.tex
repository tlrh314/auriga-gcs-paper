...
\begin{figure}
    ...
    \caption{
        ...
        to mass in the MW (M31) GCS, i.e. the logarithm of the mass ratio. The
        number in each bin shows the color-coded value that is plotted, and the
        (median) star particle count is given in parenthesis. Note that the three 
        bins in the upper right corner are left blank because the observations
        have zero mass there.
