...
In Figure~\ref{fig:MW-FeHRgc} we show the two-dimensional mass-weighted 
...
We consider the metallicity distribution in Sec.~\ref{sec:metallicity} 
the distribution of galactocentric radii in Sec.~\ref{sec:radial}, and the
...
Figure~\ref{fig:FeH} shows a mass-weighted metallicity distribution of the
Auriga L4 median
for \emph{all stars} (orange dotted), \emph{old stars / GC candidates} 
