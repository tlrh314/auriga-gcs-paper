...
\begin{figure}
    ...
    \caption{
        ...
        particles in our Auriga subsets compared to the MW (M31) GCS shown in
        purple (magenta). The black solid (open) dot shows values of the
        metal-rich (metal-poor) component of the MW GCS as quoted by
        \citep[][p. 38]{1998gcs..book.....A}.
        \label{fig:FeH_mu_sigma}
    }
\end{figure}

Figure~\ref{fig:FeH_mu_sigma} shows the mean and standard deviation of the
[Fe/H] distribution of star particles in the Auriga simulations. The mean
...
as black solid (open) dots. We further discuss the comparison between the
