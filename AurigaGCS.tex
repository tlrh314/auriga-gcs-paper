...
mass in the MW (M31) GCS to obtain the median mass ratio produced by the star
formation model implemented in the Auriga simulations. See the top (bottom) panel
of Figure~\ref{fig:Au-FeHRgc-ratio} for mass ratio with respect to the MW (M31) GCS.
...
The top panel of Figure~\ref{fig:Au-FeHRgc-ratio} shows that the mass ratio for 
