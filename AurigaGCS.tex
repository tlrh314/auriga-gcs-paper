...
Section~\ref{sec:discussion_FeHRgc},
...
combination of both in Sec.~\ref{sec:FeHRgc}.
...
the $1\sigma$ interval (i.e. scatter between runs with different initial 
conditions which thus have unique merger histories). We notice once more that
the peak metallicity shifts from $0$ to $-0.5$ for old stars (orange solid)
compared to all stars (orange dotted).
(orange solid), \emph{old in-situ} stars (blue solid), and \emph{old accreted} stars
(red solid). 
of \emph{all stars} (orange dotted), 

The MW (M31) GCS is shown in purple (magenta). We use the 
...
See Figure~\ref{fig:observations_FeHRgc} in Section~\ref{sec:observations_FeHRgc}.
