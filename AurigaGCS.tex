...
Moreover, none of the simulations has a (total) population of GC 
...
are to give rise to a GCS that can be similar to the GCS that is observed
in the MW. Moreover, either a lower formation efficiency is required at
...
to the bar or bulge. Compared to M31, the mass ratio (bottom panel of 
Figure~\ref{fig:Au-FeHRgc-ratio}) shows a less clear trend than for the MW,
...
simulations to yield a GCS consistent with that of M31.
