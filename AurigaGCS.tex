...
coordinate system: $X$ points toward Galactic center, $Y$ in direction of 
...
assuming the solar radius $R_\odot=8$~kpc.}, and absolute 
...
C11 delivers a uniform set of spectroscopic observations $316$ out of the 
$339$ GCs in the inner $1^\circ.6 (\sim 21)$~kpc, calibrated using the Milky 
Way GCS. 

Globular clusters in the outer halo of M31, up to projected radii 
$R_{\text{proj}}\sim150$~kpc, are observed in the Pan-Andromeda Archaeological 
Survey \citep[PAndAS, ][hereafter H14]{2014MNRAS.442.2165H}, see also
\citet{2014MNRAS.442.2929V, 2019MNRAS.484.1756M}. H14 presents the
discovery of 59 new GCs and publishes updates to RBC~5. The work of H14 is
incorporated in the latest version\footnote{dated 23 Sep 2015; retrieved
from \url{https://www.cfa.harvard.edu/oir/eg/m31clusters/M31_Hectospec.html}} 
of the C11 dataset. It seems that the 2015 edition of C11 is the most recent 
aggregated dataset M31's GCS and we will therefore use this troughout the 
remainder of this work.

The relevant fields in the C11 dataset are the age, metallicities, and 
...
We adopt the values 
$(\alpha_0, \delta_0) = (0^{\text{h}}42^{\text{m}}44.3^{\text{s}}, 
+41^{\circ}16'9")$\footnote{See \url{https://ned.ipac.caltech.edu/}} , and  $D_{\text{M31}} = 778$~kpc 
(TODO: reference).
