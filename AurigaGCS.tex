...
mass ratio up to $-0.9$, above which the simulations produce a higher mass ratio 
...
\begin{figure}
    ...
    \caption{
        ...
        excess than the median, conversely blue highlights bins with a lower than
        median mass ratio. The number in each bin shows the color-coded value 
        that is plotted, and the (median) star particle count is given in 
        parenthesis. Note that the three bins in the upper right corner are white
        because the observations have zero mass there.
