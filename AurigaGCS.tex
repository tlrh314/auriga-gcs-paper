...
mass-ratio for different galactocentric radius-metallicity 
($R_{\text{gal}}$-[Fe/H]) bins of simulated GC candidates
relative to the observed mass in the MW and M31 GC systems. This implies different 
...
the distribution of $R_{\text{gal}}$ . Overall, the Auriga simulations produce 
