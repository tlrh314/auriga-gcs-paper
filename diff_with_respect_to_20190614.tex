...
%DIF ADD AurigaGCS.tex            Mon Jun 24 11:49:16 2019
%
...
of \mbox{Au4-10}\footnote{The nomenclature is `Au' for Auriga, followed by the
resolution level (4) and halo number (10, indicating which set of initial
conditions was used the run).}, \mbox{Au4-21}, and \mbox{Au4-4}, showing the GC
candidates in green. The accreted GC candidates are shown in red, and the insitu 
subpopulation in blue. The top panel of the left panel shows the MW (M31) GC 
system in purple (magenta). We overplot a double Gaussian for the MW GCS (the 
purple dashed lines), adopting literature values of the mean $\mu$ and standard
deviation $\sigma$ of the metal-rich and metal-poor populations \citep[][p. 38]{Harris2001}.

We find that the age cut, on average, lowers the mean metallicity from $0.0$ to $-0.5$.
...
\mbox{Au4-21}), and ${\sim}0.5$ dex for \mbox{Au4-10}, \mbox{Au4-16}, \mbox{Au4-17},
...
typical examples of individual (simulated) galaxies. Figure~\ref{fig:FeH} shows 
the mass-weighted metallicity distribution of all Auriga L4 galaxies. Once again 
we notice that the peak metallicity shifts down from $0$ to $-0.5$ for old stars
(green solid) compared to all stars (green dotted), and we learn that the mass at 
the peak lowers by roughly one dex. The mass budget of the old stars is dominated
by the old insitu population (blue solid) below [Fe/H]~=~$-1$, and by the old accreted
